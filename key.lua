...
local Config = {
    ...
    ServiceId       = 24771, -- Your PlatoBoost Service ID
    PlatoSecret     = "bdd687b1-f3b5-4ef5-9040-306e93bc1405", -- Your PlatoBoost Secret Key

    -- [2] Anti-Bypass / Global Secret Variable
    Secret          = "kkop2610", -- This makes the script ONLY run from the key script. Even if they copy the original obfuscated script to bypass the key, they won't be able to!
    
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/KopKrt/keysys/refs/heads/main/script.lua", -- The raw URL of your main script
    ...
    HubName         = "AOI HUB", -- The main title shown at the top of the GUI
    HubDescription  = "WE LOVE KATX" -- The text shown below the title
}
